...
class CellSiteService:
    ...
    def process_file(self, file, params, project_id=None):
        ...
        # Save file (supports FileStorage or BytesIO)
        ...
        try:
            ...
            if df is not None and not df.empty:
                ...
                # Clean site_key_inferred for fallback
                ...
                # ✅ FINAL UNIQUE KEY FIX (guaranteed uniqueness per row)

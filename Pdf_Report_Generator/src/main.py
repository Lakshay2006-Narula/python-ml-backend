...
from src.map_generator import generate_handover_map, detect_handover_events
...
from src.email_service import send_report_ready_email
...
def main(project_id: int, user_id: int | None = None, report_id: str | None = None):
    ...
    # In local/dev, keep temp files for validation.
    # Uncomment for production cleanup once report_id isolation is fully deployed.
...
if __name__ == "__main__":
    main(project_id=149, user_id=152)

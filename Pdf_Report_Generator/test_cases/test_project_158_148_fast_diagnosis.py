"""
Optimized Project 158 & 148 Diagnosis Test
===========================================
...
def test_project_158():
    ...
    try:
        ...
        if not regions:
            ...
            print(f"✓ Polygons found: {len(regions)}")
                ...
                if bounds:
                    ...
                    if sample_result:
                        ...
                        if sample_result['inside'] == 0:
                            print(f"\n    ❌ DIAGNOSIS: DATA POINTS DO NOT FALL INSIDE POLYGON")
...
def test_project_148():
    ...
    try:
        ...
        print(f"\n⚠️  Key question: Is filtered data count showing correctly in report?")
...
if __name__ == "__main__":
    ...
    print("\n")
    print_section("DIAGNOSIS NOTES", "=")
    print("""
Key findings will help identify:
1. Project 158: If polygon is missing or misaligned
2. Project 148: If data is lost due to coordinate filtering or polygon mismatch
3. Why session counts in report don't match database

Next steps:
1. Review output for polygon and data point mismatch
2. Check if load_project_data is caching issues
3. Verify KPI analysis is using correct filtered_df
""")
